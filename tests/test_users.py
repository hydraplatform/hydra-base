...
class TestUser:
    ...
    def test_add_user(self, session, client, user_json_object):
    ...
    def test_update_user_password(self, session, client, user_json_object):
    ...
    def test_add_role(self, session, client, role_json_object):
    ...
    def test_add_perm(self, session, client, perm_json_object):
    ...
    def test_set_user_role(self, session, client, user_json_object, role_json_object):
    ...
    def test_set_role_perm(self, session, client, role_json_object, perm_json_object):
    ...
    def test_get_users(self, session, client, user_json_object):
    ...
    def test_get_perms(self, client, session):
    ...
    def test_get_roles(self, client, session):
    ...
    def test_get_user_roles(self, client, session):
        roles = client.get_user_roles(1)
        assert len(roles) == 1
        assert roles[0].code == 'admin'

    def test_get_user_permissions(self, client, session):
