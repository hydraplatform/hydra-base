    ...
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.create_table(
                "tDataset_new",
                sa.Column(
                    "id", sa.Integer(), primary_key=True, index=True, nullable=False
                ),
                sa.Column("name", sa.String(200), nullable=False),
                sa.Column("type", sa.String(60), nullable=False),
                sa.Column(
                    "unit_id", sa.Integer(), sa.ForeignKey("tUnit.id"), nullable=True
                ),
            ...
            op.execute(
                "insert into tDataset_new (id, name, type, unit_id, hash, cr_date, created_by, updated_by, updated_at, hidden, value) select id, name, type, unit_id, hash, cr_date, created_by, null, null, hidden, value from tDataset"
            )
...
def downgrade():
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.execute(
                "insert into tDataset_new (id, name, type, unit_id, hash, cr_date, created_by, hidden, value) select id, name, type, unit_id, hash, cr_date, created_by, hidden, value from tDataset"
            )
