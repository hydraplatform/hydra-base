...
def upgrade():
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.execute(
                "insert into tTemplateType_new (id, name, description, template_id, resource_type, alias, cr_date, layout) select id, name, '', template_id, resource_type, alias, cr_date, layout from tTemplate"
            )
...
def downgrade():
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.execute(
                "insert into tTemplateType_new (id, name, template_id, resource_type, alias, cr_date, layout) select id, name, template_id, resource_type, alias, cr_date, layout from tTemplateType"
            )
