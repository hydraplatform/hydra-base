...
def upgrade():
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.execute(
                "insert into tUser_new (id, username, password, display_name, last_login, last_edit, cr_date) select user_id, username, password, display_name, last_login, last_edit, cr_date from tUser"
            )
...
def downgrade():
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.execute(
                "insert into tUser_new (user_id, username, password, display_name, last_login, last_edit, cr_date) select id, username, password, display_name, last_login, last_edit, cr_date from tUser"
            )
