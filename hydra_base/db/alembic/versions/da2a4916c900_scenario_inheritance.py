...
def upgrade():
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.execute(
                "insert into tScenario_new (id, name, description, layout, status, cr_date, created_by, network_id, start_time, end_time, time_step, locked, parent_id) select id, name, description, layout, status, cr_date, created_by, network_id, start_time, end_time, time_step, locked, null from tScenario"
            )
...
def downgrade():
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.execute(
                "insert into tScenario_new (id, name, description, layout, status, cr_date, created_by, network_id, start_time, end_time, time_step, locked) select id, name, description, layout, status, cr_date, created_by, network_id, start_time, end_time, time_step, locked from tScenario"
            )
