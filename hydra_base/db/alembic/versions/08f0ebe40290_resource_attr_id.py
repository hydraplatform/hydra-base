    ...
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.create_table(
                ...
                sa.Column(
                    "attr_id", sa.Integer(), sa.ForeignKey("tAttr.id"), nullable=False
                ),
    ...
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            op.alter_column(
                "tResourceAttr",
                "id",
                new_column_name="resource_attr_id",
                existing_type=sa.Integer(),
                primary_key=True,
                autoincrement=True,
                nullable=False,
        ...
        try:
            ...
            op.create_table(
                "tResourceAttr_new",
                sa.Column(
                    "resource_attr_id", sa.Integer(), primary_key=True, nullable=False
                ),
                sa.Column(
                    "attr_id", sa.Integer(), sa.ForeignKey("tAttr.id"), nullable=False
                ),
            ...
            op.execute(
                "insert into tResourceAttr_new (resource_attr_id, attr_id, ref_key, network_id, project_id, node_id, link_id, group_id, attr_is_var, cr_date) select id, attr_id, ref_key, network_id, project_id, node_id, link_id, group_id, attr_is_var, cr_date from tResourceAttr"
            )
