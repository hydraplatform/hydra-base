...
def upgrade():
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.execute(
                "insert into tPerm_new (id, name, code, cr_date) select perm_id, perm_name, perm_code, cr_date from tPerm"
            )
            ...
            op.execute(
                "insert into tRole_new (id, name, code, cr_date) select role_id, role_name, role_code, cr_date from tRole"
            )
