...
def upgrade():
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.execute(
                "insert into tRule_new (id, name, description, ref_key, status, value, scenario_id, network_id, node_id, link_id, group_id, cr_date) select rule_id, rule_name, rule_description, ref_key, status, value, scenario_id, network_id, node_id, link_id, group_id, cr_date from tRule"
            )
...
def downgrade():
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.execute(
                "insert into tRule_new (rule_id, rule_name, rule_description, ref_key, status, value, scenario_id, network_id, node_id, link_id, group_id, cr_date) select id, name, description, ref_key, status, value, scenario_id, network_id, node_id, link_id, group_id, cr_date from tRule"
            )
