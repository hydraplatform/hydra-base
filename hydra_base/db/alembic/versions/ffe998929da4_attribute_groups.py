...
def upgrade():
    try:
        ...
        op.create_table(
            ...
            sa.Column(
                "description",
                sa.Text().with_variant(mysql.TEXT(1000), "mysql"),
                nullable=True,
            ),
            sa.Column(
                "layout",
                sa.Text().with_variant(mysql.TEXT(5000), "mysql"),
                nullable=True,
            ),
            sa.Column(
                "exclusive",
    ...
    try:
        ...
        op.create_unique_constraint(
            "unique net name", "tNetwork", ["name", "project_id"]
        )
        ...
        op.create_foreign_key(
            None, "tResourceAttrMap", "tNetwork", ["network_a_id"], ["id"]
        )
        op.create_foreign_key(
            None, "tResourceAttrMap", "tNetwork", ["network_b_id"], ["id"]
        )
        op.create_foreign_key(
            None, "tResourceGroup", "tNetwork", ["network_id"], ["id"]
        )
