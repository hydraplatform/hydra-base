        ...
        try:
            ...
            op.create_table(
                ...
                sa.Column(
                    "type_id",
                    sa.Integer(),
                    sa.ForeignKey("tTemplateType.id"),
                    primary_key=False,
                    nullable=False,
                ),
                ...
                sa.Column(
                    "node_id", sa.Integer(), sa.ForeignKey("tNode.id"), nullable=True
                ),
                sa.Column(
                    "link_id", sa.Integer(), sa.ForeignKey("tLink.id"), nullable=True
                ),
                sa.Column(
                    "group_id",
                    sa.Integer(),
            ...
            op.execute(
                "insert into tResourceType_new (id, type_id, ref_key, network_id, node_id, link_id, group_id, cr_date) select resource_type_id, type_id, ref_key, network_id, node_id, link_id, group_id, cr_date from tResourceType"
            )
