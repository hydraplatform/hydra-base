    ...
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.alter_column(
                ...
                existing_type=sa.String(60),
                server_default=sa.text("'dimensionless'"),
            )
            op.alter_column(
                "tAttr",
                "attr_description",
        ...
        try:
            ...
            op.execute(
                "insert into tAttr_new (id, name, dimension, description, cr_date) select attr_id, attr_name, attr_dimen, attr_description, cr_date from tAttr"
            )
    ...
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.alter_column(
                "tAttr",
                "dimension",
                new_column_name="attr_dimen",
                existing_type=sa.String(60),
                server_default=text("'dimensionless'"),
            )
            op.alter_column(
                "tAttr",
                "description",
                new_column_name="attr_description",
                existing_type=sa.String(1000),
            )
        except Exception as e:
            log.exception(e)
        ...
        try:
            ...
            op.execute(
                "insert into tAttr_new (attr_id, attr_name, attr_dimen, attr_description, cr_date) select id, name, dimension, description, cr_date from tAttr"
            )
