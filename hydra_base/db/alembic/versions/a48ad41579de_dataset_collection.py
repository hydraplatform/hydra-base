...
def upgrade():
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.execute(
                "insert into tDatasetCollection_new (id, name, cr_date) select collection_id, collection_name, cr_date from tDatasetCollection"
            )
    ...
    if op.get_bind().dialect.name == "mysql":
        ...
        try:
            ...
            op.create_table(
                "tDatasetCollection_new",
                sa.Column(
                    "collection_id", sa.Integer(), primary_key=True, nullable=False
                ),
            ...
            op.execute(
                "insert into tDatasetCollection_new (collection_id, collection_name, cr_date) select id, name, cr_date from tDatasetCollection"
            )
