...
class Dataframe(DataType):
    ...
    def _create_dataframe(cls, value):
        ...
        try:
            ...
            ordered_jo = json.loads(
                six.text_type(value), object_pairs_hook=collections.OrderedDict
            )
            ...
            log.warning(
                "An error occurred creating the new data frame: %s. Defaulting to a simple read_json"
                % (e)
            )
