...
def check_perm(user_id, permission_code):
    ...
    try:
        ...
        qry = (
            db.DBSession.query(RoleUser.role_id)
        ...
        raise PermissionError(
            "Permission denied. User %s does not have permission %s"
...
def check_role(user_id, role_code):
    ...
    try:
        ...
        raise PermissionError(
            "Permission denied. User %s does not have role %s" % (user_id, role_code)
        )
